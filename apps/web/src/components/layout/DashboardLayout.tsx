...
export default function DashboardLayout({
  ...
  const menu = ["dashboard", "products", "keyvalue"];
  ...
  return (
    <>
      ...
      >
        ...
        <Grid item xs={12} borderBottom={1} borderColor='#f1f1f1' className="bg-indigo-900/20">

        </Grid>
          <Grid item xs={2} borderRight={1} borderColor='#f1f1f1'>
            <Paper
