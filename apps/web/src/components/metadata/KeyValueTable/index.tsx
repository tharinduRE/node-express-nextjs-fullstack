...
const headCells: HeadCell<KeyValue<any>>[] = [
  {
    id: 'key',
  },
  {
...
export default function TableView(props: TableViewProps<KeyValue<any>>) {
  ...
  const handleSearchField = _.debounce((property: keyof KeyValue<any>, value: any) => {
    {
